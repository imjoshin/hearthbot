...
export const BOT = {
  ...
  ACTIVITIES: [
    {weight: 10, type: ActivityType.Playing, name: `Hearthstone`},
    {weight: 8, type: ActivityType.Watching, name: `over the Inn`},
    {weight: 4, type: ActivityType.Watching, name: `a Tavern Brawl`},
    {weight: 2, type: ActivityType.Playing, name: `World of Warcraft`},
    {weight: 2, type: ActivityType.Playing, name: `Heroes of the Storm`},
    {weight: 1, type: ActivityType.Playing, name: `World of Warcraft TCG`},
